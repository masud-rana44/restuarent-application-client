      ...
      <div className="lg:hidden flex items-center space-x-4">
       ...
       {!isMenuOpen ? <Menu className="h-6 w-6"/> :
        <X className="h-6 w-6"/>}
           ...
           {isMenuOpen && <nav className="absolute lg:hidden top-20 left-0 w-full  font-medium text-[15px] uppercase flex items-center justify-center space-x-6 bg-black/30 p-10">
